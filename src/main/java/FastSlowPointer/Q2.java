...
public class Q2 {
    ...
    public static boolean isHappy(int n) {
        ...
        //a series of numbers that are replacement of there previous number
        ...
        while(fast != 1 && slow != fast) {
            ...
            fast = getNext(getNext(fast));//get replacement of the replacement of the current fast
            //until it reaches 1
        }
//check whether that's the case is 1
    ...
    public static int getNext(int n) {
        int sum = 0;
//we treat the sum of the constituent digits as the next number in list
